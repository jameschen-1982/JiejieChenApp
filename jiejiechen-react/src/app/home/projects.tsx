...
export default function Projects() {
  return <>
    { /* Projects */}
    <section id="projects" className="flex my-auto lg:min-h-[calc(100vh-140px)] items-center justify-center p-5 bg-projects">
      <div className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-center text-lg font-semibold leading-8 text-gray-900">
            Projects that I have delivered
          </h2>
          <div className="mx-auto mt-10 grid max-w-lg items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-3">
