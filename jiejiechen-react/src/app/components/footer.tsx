export default function Footer() {
  ...
  return (
    <footer className="bg-white rounded-lg shadow mt-4 mb-0 dark:bg-gray-800">
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {thisYear} <a href="https://www.jiejiechen.com" className="hover:underline">Jiejie Chen React/Next.JS Demo</a>. All Rights Reserved.
    </span>
