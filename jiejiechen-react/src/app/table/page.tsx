...
export default function Page() {
  ...
  if (auth.isLoading || isTableLoading) {
  ...
  if (!auth.isAuthenticated) {
    return <div className="h-screen flex flex-col items-center justify-center text-center">
      <div className="flex">
        ...
        <button
          onClick={async () => {
            await auth.signinRedirect({state: {returnTo: "/table"} as CustomOidcState, login_hint: "demo@example.com"});
          }}
      ...
      <div className="my-5">(Username/password: demo@example.com / Abc123456!)</div>
    </div>;
  }
